  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        h2: ({ children }) => (
          <h2 className="text-3xl font-semibold font-audiowide text-blue-500 mt-6 mb-3">{children}</h2>
        ),
        h3: ({ children }) => (
          <h3 className="text-2xl font-medium font-audiowide text-blue-400 mt-5 mb-2">{children}</h3>
        ),
        p: ({ children }) => <p className="text-lg text-gray-700 mb-4">{children}</p>,
        ul: ({ children }) => <ul className="list-disc list-inside pl-6 text-gray-700 mb-4">{children}</ul>,
        ol: ({ children }) => <ol className="list-decimal list-inside pl-6 text-gray-700 mb-4">{children}</ol>,
        ...
        pre: ({ children }) => (
          <pre className="p-4 rounded-md overflow-x-auto mb-4">
            {children}
          </pre>
        ),
        table: ({ children }) => (
